		...
		<main id="main" class="site-main" role="main">
			...
			<div class="resources-wrapper">
				<div class="resource">
					...
					<p>
						<?php echo CFS()->get( 'resources_text' ); ?>
					</p>
				</div>
				<div class="btn-partners">
					<h3> Become a Partner</h3>
					<a href="<?php echo esc_url( site_url( '/general-inquiries/' ) ); ?>" rel="general inquiries"><button class="get-involved">Get In Touch</button></a>
